...
uint32_t const ColorPalette[16] = {0x222222, 0xFFFFFF, 0xFF2222, 0x22FF22, 0x2222FF};
...
uint8_t FontX[256] = {0, 2, 4, 6, 12, 18, 22, 27, 29, 32, 35, 40, 44, 46, 50, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 98, 100, 104, 108, 112, 116, 121, 125, 129, 133, 137, 141, 145, 149, 153, 155, 159, 163, 167, 173, 178, 182, 186, 190, 194, 198, 202, 207, 212, 218, 222, 226};
uint8_t FontWidth[256] = {2, 2, 2, 6, 6, 4, 5, 2, 3, 3, 5, 4, 2, 4, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 2, 2, 4, 4, 4, 4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 2, 4, 4, 4, 6, 5, 4, 4, 4, 4, 4, 4, 5, 5, 6, 4, 4};
...
- (void)drawText:(NSString *)text x:(int)x y:(int)y
{
    for (NSUInteger index = 0; index < text.length; index++)
    {
        ...
        {
            NSUInteger fontIndex = currentChar - 32;
